...
[![Four Modes](https://img.shields.io/badge/Modes-4-d75d32?style=flat-square)](#네-가지-출력-하나의-종이-조각-논리)
...
<table>
  <tr>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2090118050637090988"><img src="./assets/examples/sample-01.jpg" alt="XXD Panel 014 예시 1"></a></td>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2090118050637090988"><img src="./assets/examples/sample-02.jpg" alt="XXD Panel 014 예시 2"></a></td>
  </tr>
  <tr>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2090118050637090988"><img src="./assets/examples/sample-03.jpg" alt="XXD Panel 014 예시 3"></a></td>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2090118050637090988"><img src="./assets/examples/sample-04.jpg" alt="XXD Panel 014 예시 4"></a></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 014 예시 5"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 014 예시 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 014 예시 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 014 예시 8"></td>
  </tr>
</table>

## 추가 3:4 상하 구성 예시

위 16:9 예시와 같은 네 개의 독립 소스를 완전한 3:4 상하 캔버스로 다시 생성했습니다. 위쪽은 현실 사진을 유지하고 아래쪽은 Panel 014의 원본 프롬프트에 따라 재구성합니다. 영어 문구는 각 사진의 내용·분위기·함의에서만 생성했으며 모든 결과를 개별 검수했습니다.

<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 014 추가 상하 예시 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 014 추가 상하 예시 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 014 추가 상하 예시 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 014 추가 상하 예시 4"></td>
  </tr>
</table>

> 추가 예시: 천샹 포스터 그룹에서 해당 천샹 포스터 그룹의 네 장을 파일명 순서로 사용하고, 이 Panel의 원본 브리프에 따라 16:9 좌우 구성과 영어 자동 생성 문구로 제작했습니다.

> [샤오샤오둥（@xiaoxiaodong01）](https://x.com/xiaoxiaodong01/status/2090118050637090988) · 2026-08-19<br>
> GPT2 x 折纸 x 转换 x 美学提示词 x VOL.014

<p align="center"><a href="https://x.com/xiaoxiaodong01/status/2090118050637090988">원문 게시물과 전체 프롬프트 보기 →</a></p>

이 예시는 014의 미학적 의도를 보여 줄 뿐이며, 예시의 주제, 구성, 색상, 문구, 이전 캔버스 비율은 생성 참고나 현재 기본값이 되지 않습니다.

> 접기와 절단면 · 겹침과 끼움 · 원본의 무게중심 · 실제 종이 섬유 · 읽히는 종이 문자

XXD Panel 014는 Codex와 호환 에이전트를 위한 이미지 생성 Skill입니다. 정체성, 실루엣, 자세와 서사 관계를 보존한 뒤 접기, 절단면, 겹침, 끼움, 가림, 종이 조각의 결합으로 원본이 한눈에 읽히는 현대 종이 조각을 만듭니다.

구도는 고정 중앙이 아니라 사진의 무게중심, 윤곽 흐름, 질량 비율과 동작 방향을 따릅니다. 원본 색은 조화롭고 선명한 종이 색군으로 바뀌며, 부드러운 확산광이 섬유, 접힌 자국, 절단면, 두께, 층 간격과 자연 그림자를 실제처럼 보여 줍니다. 주 제목도 접거나 오린 종이로 만들어 공간 구조에 참여합니다.
...
**Panel 014**은 원본 사진의 핵심을 보존하면서 다음과 같은 시각 방향을 원하는 작업에 적합합니다: **사진을 손으로 만든 듯한 현대 종이 조각으로 재구성합니다**. 먼저 용도와 원하는 결과를 확인한 뒤 구성, 크기, 텍스트와 전달 형식을 결정합니다.
...
> XXD Panel 014으로 이 이미지를 작업하고, 먼저 가장 어울리는 구성과 크기를 추천해 줘.
...
## 빠른 판단: XXD Panel 014이 나에게 맞을까요?

| 궁금한 점 | 이 스타일이 주는 답 |
|---|---|
| **얻게 되는 결과** | 사진을 손으로 만든 듯한 현대 종이 조각으로 재구성합니다 |
| **한눈에 알아볼 특징** | 접기와 절단면 · 겹침과 끼움 · 원본의 무게중심 · 실제 종이 섬유 · 읽히는 종이 문자 |
...
```text
정체성／실루엣／자세／관계 고정 → 무게중심, 질량, 동작 방향 읽기 → 원본 고유 접기 지도 만들기 → 접힌 면, 절단면, 겹침, 끼움, 여백 형태로 주제 요약 → 위계, 축, 삼각 안정, 대각 긴장, 가림으로 하나의 초점 구성 → 원본 종이 색군으로 번역 → 읽히는 제목을 종이 공간 구조로 만들기
```

무관한 사진으로 바꿔도 조각의 실루엣, 접기 지도, 무게 배분, 종이 색군, 보조 종이 조각과 문자 관계가 거의 그대로 성립한다면 014가 아닙니다.

## 완성작에서 바로 알아볼 수 있는 스타일 특징

- **원본 정체성:** 최소 세 가지 고유 단서로 실루엣, 자세, 동작, 구조, 크기, 여백 형태와 관계를 보존합니다.
- **실제 종이 구조:** 접기, 절단면, 겹침, 끼움, 교차, 가림, 결합이 물리적으로 설득력 있고 매끈한 로우폴리 CG가 아닙니다.
- **원본 주도 구도:** 무게중심, 윤곽, 질량, 방향에 따라 비대칭 배치, 부분 크롭, 연장, 부유를 정하며 기계적 중앙과 평균 대칭을 피합니다.
- **하나의 초점:** 위계, 크기 대비, 축, 삼각 안정, 대각 긴장, 양·음 공간이 한 주 조각을 지지하고 보조 종이는 경쟁하지 않습니다.
- **원본 종이 색군:** 동색 명암, 인접색, 소량의 대비색으로 면과 깊이를 나누고 밝은 배경과 넓은 여백을 유지합니다.
- **실제 재질:** 부드러운 확산광이 섬유, 접힌 자국, 절단면, 두께, 층 분리와 자연 그림자를 분명히 보여 줍니다.
- **종이 문자:** 짧은 단어나 제목이 감싸기, 축 연장, 윤곽 밀착, 받치기, 끼워 넣기, 겹침, 부유로 읽히는 공간 구조가 됩니다.
...
이미지 폴더를 직접 전달하면 이 병사 Skill이 같은 Panel 014의 원본 미학으로 일괄 처리합니다. 일반 래스터 형식을 기본적으로 재귀 탐색하고 수량을 먼저 알린 뒤 모드·크기·텍스트·언어를 한 번만 확인합니다. 각 이미지는 내용이나 문구가 섞이지 않도록 독립 생성하며 전체 배치는 하나의 평면 작업 디렉터리만 사용합니다. 개별 실패는 기록하고 이후 이미지를 조용히 누락하지 않습니다.
...
```text
/xxd-panel-014 photo.jpg --mode top-bottom,design-only --size auto,3:4,9:16 --text prompt --locale ja-JP
```
...
```text
/xxd-panel-014 photo.jpg --prefs last
/xxd-panel-014 photo.jpg --prefs edit
/xxd-panel-014 photo.jpg --prefs new
```
...
/xxd-panel-014 photo.jpg --mode top-bottom --size auto --text prompt --locale ko-KR

# 좌우 비교: 3:2 가로형, 글자 없음
/xxd-panel-014 photo.jpg --mode left-right --size 3:2 --text none

# 디자인 전용: 9:16 휴대폰 세로형, 한국어 문구
/xxd-panel-014 photo.jpg --mode design-only --size 9:16 --text prompt --locale ko-KR

# 연결형 4종 배경화면: 기준 이미지 후 기기별 재구성
/xxd-panel-014 photo.jpg --mode wallpaper-pack --wallpaper linked --text none

# 독립형 배경화면: 기기별 정확한 해상도 지정
/xxd-panel-014 photo.jpg --mode wallpaper-pack --wallpaper independent --wallpaper-size phone=1440x3200,ipad=2048x2732,desktop=3840x2160,watch=1024x1024 --text none

# 원본 이미지 비율 따르기
/xxd-panel-014 photo.jpg --mode design-only --size source --text none

# 정사각형·세로·가로 완성 구도를 각각 생성
/xxd-panel-014 photo.jpg --mode design-only --size 1:1,3:4,16:9 --text none

# 사용자 비율과 정확한 픽셀을 함께 지정
/xxd-panel-014 photo.jpg --mode design-only --size 11:14,2160x3840,3840x2160 --text none

# 원본 프롬프트가 문구를 만들고 언어만 제한
/xxd-panel-014 photo.jpg --mode design-only --size 3:4 --text prompt --locale ko-KR

# 정확한 문구를 재작성·번역·제목 추가 없이 사용
/xxd-panel-014 photo.jpg --mode design-only --size 3:4 --copy "빛을 이곳에 남겨 두기" --locale ko-KR

# 2개 모드 × 3개 크기로 독립적인 완성 구도 6개 생성
/xxd-panel-014 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ko-KR

# 폴더 전체에 Panel 014 적용, 공통 설정은 한 번만 확정
/xxd-panel-014 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ko-KR

# 반복 매개변수도 누적하며 지정 루트 아래로 출력
/xxd-panel-014 photo.jpg --mode top-bottom --mode left-right --size 3:4 --size 16:9 --text none --out ./deliveries
```
...
```bash
npx skills add https://github.com/nevertoday/xxd-panel-014 --skill xxd-panel-014
```
...
Claude Code 사용자는 같은 폴더를 `~/.claude/skills/xxd-panel-014`에 연결할 수 있습니다. 설치 후 에이전트 세션을 다시 시작하세요.
...
- [Skill 워크플로](SKILL.md)
- [중문 런타임 어댑터](references/xxd-panel-014-prompt.zh-CN.md)
- [영문 런타임 어댑터](references/xxd-panel-014-prompt.en.md)
...
**사진을 로우폴리로 만들지 말고, 종이가 실제로 무게와 동작과 관계를 접어 내게 하세요.**
